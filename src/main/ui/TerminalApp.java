...
// Represents the application through a terminal based user interface
public class TerminalApp implements Serializable {
    ...
    static void ingredientsWriter(IngredientsList yourIngredientsList) throws IngredientException {
        ...
        for (int i = 0; !(choice.equals("yes")); i++) {
            ...
            Ingredient yourIngredient = null; // User gathered variables are set
            yourIngredient = new Ingredient(name, amount, unit);
    ...
    //          way
    static void recipeReader(RecipesList yourRecipes) throws NoTimerException {
        Scanner scanner = new Scanner(System.in);
    ...
    static void readRecipe(Recipe chosenRecipe) throws NoTimerException {
        Scanner scanner = new Scanner(System.in);
        String finishQue = "";
        String dummy = "";
    ...
    static void saveYourIngredientsList(RecipesList yourRecipesList, String path) throws IOException {
    ...
    // EFFECTS: Returns the loaded save and begins terminal application
    public static void startTerminalApp() throws IOException, ClassNotFoundException, IngredientException,
            NoTimerException {
        ...
        Scanner scanner = new Scanner(System.in);
        // Greeting to program
        System.out.println("Welcome to Su Chef, your chef!");
        System.out.println("You can quit from the main menu at anytime by typing 'quit'");
        // Selection of what user would like to do. Loop in-case they make a mistake.
        String choice = "";
        for (int i = 0; !(choice.equals("quit")); i++) {
            System.out.println("Would you like to create a new Recipe or Read one of your Recipes? (New/Read)");
            choice = scanner.nextLine();
            if (choice.equals("New")) {
                recipeWriter(yourRecipesList);
            } else if (choice.equals("Read")) {
                recipeReader(yourRecipesList);
            } else if (choice.equals("quit")) {
                break;
            } else {
                System.out.println("Please input either 'New' or 'Read'");
                choice = "";
            }
        }
        saveYourIngredientsList(yourRecipesList, saveFile);
    }
}
